...
//   getWordList(db, language_id) {
//     const ll = new LinkedList(db, language_id);
//     return ll.loadFromDb();
//   },



//   moveLinkedList(db, linkedNodes) {
//     return db.transaction(trx =>
//       Promise.all([
//         db('language')
//           .transacting(trx)
//           .where('id', linkedNodes.id)
//           .update({
//             total_score: linkedNodes.total_score,
//             head: linkedNodes.head.value.language_id,
//           }
//           ),
